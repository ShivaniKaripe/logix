...
<%
  ...
  If (Request.QueryString("submit") = "Submit") Then
    ...
    MyCommon.QueryStr = "dbo.pt_CustomerInfoChanges_Insert"
    MyCommon.Open_LXSsp()
    MyCommon.LXSsp.Parameters.Add("@CustomerPK", SqlDbType.BigInt).Value = CustomerPK
    MyCommon.LXSsp.Parameters.Add("@AdminUserID", SqlDbType.Int).Value = 1
    ...
    <tbody>
      ...
      <tr>
        <td colspan="4" align="left">
          <img src="images/preffields.png" alt="" title="" />
        </td>
      </tr>
      <tr>
