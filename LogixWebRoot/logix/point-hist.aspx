...
<%
  ...
  Response.Expires = 0
  MyCommon.AppName = "point-hist.aspx"
  ...
  Send_HeadBegin("term.pointsprogram", "term.history", l_pgID)
  ...
  Send_Logos()
  Send_Tabs(Logix, 5)
  Send_Subtabs(Logix, 51, 6, , l_pgID)
...
<div id="intro">
  <h1 id="title">
    <%
      Sendb(Copient.PhraseLib.Lookup("term.pointsprogram", LanguageID) & " #" & ProgramGroupID)
      If GName <> "" Then
