...
<%
  ...
  Response.Expires = 0
  MyCommon.AppName = "CPEoffer-not.aspx"
  ...
  Else
    ...
    If (Request.QueryString("neweliglobal") <> "") Then
      ...
      ElseIf (Request.QueryString("neweliglobal") = 2) Then
        Send("<script type=""text/javascript"">openPopup('CPEoffer-rew-discount.aspx?Phase=1&OfferID=" & OfferID & "&RewardID=" & roid & "')</script>")
      ...
      ElseIf (Request.QueryString("neweliglobal") = 8) Then
        Send("<script type=""text/javascript"">openPopup('CPEoffer-rew-point.aspx?Phase=1&OfferID=" & OfferID & "&RewardID=" & roid & "&New=1')</script>")
      ...
      ElseIf (Request.QueryString("neweliglobal") = 10) Then
        Send("<script type=""text/javascript"">openPopup('CPEoffer-rew-franking.aspx?Phase=1&OfferID=" & OfferID & "&RewardID=" & roid & "')</script>")
      ElseIf (Request.QueryString("neweliglobal") = 11) Then
        Send("<script type=""text/javascript"">openPopup('CPEoffer-rew-sv.aspx?Phase=1&OfferID=" & OfferID & "&RewardID=" & roid & "')</script>")
      ElseIf (Request.QueryString("neweliglobal") = 99) Then
        Send("<script type=""text/javascript"">openPopup('CPEoffer-rew-pmsg.aspx?Phase=2&OfferID=" & OfferID & "&RewardID=" & roid & "')</script>")
      Else
        MyCommon.QueryStr = "select PassThruRewardID, Name, PhraseID from PassThruRewards with (NoLock) order by PassThruRewardID;"
        rst = MyCommon.LRT_Select
        If rst.Rows.Count > 0 Then
          Send("<script type=""text/javascript"">openPopup('CPEoffer-rew-passthru.aspx?Phase=1&OfferID=" & OfferID & "&RewardID=" & roid & "&PassThruRewardID=" & (Request.QueryString("neweliglobal") - 12) & "')</script>")
        End If
      End If
    End If
  End If
...
<form action="CPEoffer-not.aspx" id="mainform" name="mainform">
            ...
            <%
              ...
              If (rst.Rows.Count > 0) Then
                ...
                For Each row In rst.Rows
                  ...
                  Else 
                    NotificationDisabled = IIf((Logix.UserRoles.EditTemplates), "", " disabled=""disabled""")
                  End If                  
                  ...
                  Send("onClick=""if(confirm('" & Copient.PhraseLib.Lookup("notification.confirmdelete", LanguageID) & "')) LoadDocument('CPEoffer-not.aspx?mode=DeletePrintedMsg&Phase=1&OfferID=" & OfferID & "&MessageID=" & MyCommon.NZ(row.Item("MessageID"), 0) & "&DeliverableID=" & MyCommon.NZ(row.Item("DeliverableID"), 0) & "')"" /></td>")
              ...
              If (rst.Rows.Count > 0) Then
                ...
                For Each row In rst.Rows
                  ...
                  Send("onClick=""if(confirm('" & Copient.PhraseLib.Lookup("notification.confirmdelete", LanguageID) & "')) LoadDocument('CPEoffer-not.aspx?mode=DeleteCashierMsg&OfferID=" & OfferID & "&MessageID=" & MyCommon.NZ(row.Item("MessageID"), 0) & "&DeliverableID=" & MyCommon.NZ(row.Item("DeliverableID"), 0) & "')"" /></td>")
                  Send("  <td><a href=""javascript:openPopup('CPEoffer-rew-cmsg.aspx?OfferID=" & OfferID & "&Phase=1&RewardID=" & roid & "&DeliverableID=" & MyCommon.NZ(row.Item("DeliverableID"), 0) & "')"">" & Copient.PhraseLib.Lookup("term.cashiermessage", LanguageID) & "</a></td>")
                  Send("  <td></td>")
              ...
              If (rst.Rows.Count > 0) Then
                ...
                For Each row In rst.Rows
                  ...
                  Else
                    RewardDisabled = IIf((Logix.UserRoles.EditTemplates), "", " disabled=""disabled""")
                  End If
                  DeleteGraphicURL = "CPEoffer-not.aspx?mode=DeleteGraphic&OfferID=" & OfferID & "&deliverableid=" & MyCommon.NZ(row.Item("DeliverableID"), "")
                  Send("<tr class=""shaded"">")
            ...
            <%
              ...
              If (rst.Rows.Count > 0) Then
                ...
                For Each row In rst.Rows
                  ...
                  Send("<tr class=""shaded"">")
                  Sendb(" <td><input type=""button"" class=""ex"" name=""ex"" title=""" & Copient.PhraseLib.Lookup("term.delete", LanguageID) & """" & RewardDisabled & " value=""X"" ")
                  Send("onClick=""if(confirm('" & Copient.PhraseLib.Lookup("accumulation.confirmdelete", LanguageID) & "')) LoadDocument('CPEoffer-not.aspx?mode=DeletePrintedMsg&Phase=2&OfferID=" & OfferID & "&MessageID=" & MyCommon.NZ(row.Item("MessageID"), 0) & "&DeliverableID=" & MyCommon.NZ(row.Item("DeliverableID"), 0) & "')"" /></td>")
      ...
      <div class="box" id="neweligibility">
        ...
        <%
          ...
          MyCommon.QueryStr = "SELECT PECT.EngineID, PECT.EngineSubTypeID, PECT.ComponentTypeID, DT.DeliverableTypeID, DT.Description, DT.PhraseID, PECT.Singular, " & _
                              ...
                              "WHERE EngineID=2 AND EngineSubTypeID=" & EngineSubTypeID & " AND PECT.ComponentTypeID=3 AND Enabled=1"
          ...
          Else
            ...
            ElseIf (Not IsCustomerAssigned OrElse Not IsProductAssigned) Then
              Send(Copient.PhraseLib.Detokenize("CPEoffer-not.ProdCustConRequired", LanguageID, OfferID) & "<br />")
            Else
