<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OfferEligibilitySVCondition.aspx.cs" Inherits="OfferEligibilitySVCondition" %>
...
<a id="top" name="top"></a>
  ...
  <div id="main">
    ...
    <div class="box" id="selector">
        ...
        <h2>
          <span>
            <%=PhraseLib.Lookup("term.storedvalueprogram", LanguageID)%>
          </span>
        </h2>
        ...
        <div id="cgList">
          ...
          <asp:ListBox ID="lstAvailable" runat="server" SelectionMode="Single" DataTextField="ProgramName" DataValueField="SVProgramID" Rows="12" CssClass="longer"></asp:ListBox>
        ...
        <br class="half" />
        <asp:ListBox ID="lstSelected" runat="server" SelectionMode="Single" Rows="2" CssClass="longer"  DataTextField="ProgramName" DataValueField="SVProgramID" ></asp:ListBox>
        <br />       
</div>
    </div>
    <div id="gutter" ></div>
