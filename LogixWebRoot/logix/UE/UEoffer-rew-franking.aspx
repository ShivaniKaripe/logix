...
<%
    ' *****************************************************************************
    ' * FILENAME: UEoffer-rew-franking.aspx 
    ' *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    Response.Expires = 0
    MyCommon.AppName = "UEoffer-rew-franking.aspx"
    MyCommon.Open_LogixRT()
    AdminUserID = Verify_AdminUser(MyCommon, Logix)

    BannersEnabled = (MyCommon.Fetch_SystemOption(66) = "1")
    ProtoBuild = MyCommon.Fetch_UE_SystemOption(59)
    ...
    If (Request.QueryString("save") <> "" AndAlso DeliverableID = 0) Then
        ...
        MsgAdded = Create_Message(OfferID, RewardRequired, DeliverableID)
        If (MsgAdded AndAlso DeliverableID > 0) Then
            ...
            For t = 1 To TierLevels
                ...
                Create_MessageTiers(FrankID, t, OpenDrawer, ManagerOverride, FrankFlag, FrankingText, Line1, Line2, Beep, BeepDuration, RewardValue)
            Next
...
<%
  ...
  End If
%>
<form action="UEoffer-rew-franking.aspx" id="mainform" name="mainform" onsubmit="return validateEntries();">
  <div id="intro">
  ...
  <div id="main">
    ...
    <div id="column1">
      <%
        MyCommon.QueryStr = "select TierLevel, OpenDrawer, ManagerOverride, FrankFlag, FrankingText, Line1, Line2, Beep, BeepDuration, Value " & _
        ...
        For t = 1 To TierLevels
          ...
          If GetCgiValue("t" & t & "_value") <> "" Then
            RewardValue = MyCommon.Extract_Val(GetCgiValue("t" & t & "_value"))
          ElseIf rst.Rows.Count >= t Then
            RewardValue = MyCommon.NZ(rst.Rows(t - 1).Item("Value"), 0)
          Else
            RewardValue = 0
          End If
          Send("<label for=""t" & t & "_value"">" & Copient.PhraseLib.Lookup("term.value", LanguageID) & ":</label>")
          Sendb("<input type=""text"" class=""shorter"" id=""t" & t & "_value"" name=""t" & t & "_value"" maxlength=""9"" value=""" & RewardValue & """/>")
          Send("<br />")
...
<script runat="server">
  Function Create_Message(ByVal OfferID As String, ByVal RewardRequired As Boolean, ByRef DeliverableID As Long) As Boolean
    Dim MyCommon As New Copient.CommonInc
  ...
  Sub Create_MessageTiers(ByVal FrankID As Long, ByVal TierLevel As Integer, ByVal OpenDrawer As Integer, ByVal ManagerOverride As Integer, _
                          ...
                          ByVal Beep As Integer, ByVal BeepDuration As Integer, ByVal RewardValue As Decimal)
    Dim MyCommon As New Copient.CommonInc
