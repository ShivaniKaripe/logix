...
<%
    ' *****************************************************************************
    ' * FILENAME: UEoffer-con-attribute.aspx 
    ' *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    Response.Expires = 0
    MyCommon.AppName = "UEoffer-con-attribute.aspx"
    ...
    If IncentiveAttributeID > 0 Then
        ...
        Else
            Response.Redirect("UEoffer-con-attribute.aspx?OfferID=" & OfferID)
        End If
    Else
        AttributeValues = "0"
    End If
...
function typeChange(AttributeTypeID) {
  ...
  frm.action = "UEoffer-con-attribute.aspx?OfferID=<%Sendb(OfferID)%>&AttributeTypeID=" + AttributeTypeID;
  frm.submit();
}
  ...
  <div id="intro">
    <%
      ...
      End If
        If Not isTemplate Then
            m_EditOfferRegardlessOfBuyer = (Logix.UserRoles.EditOffersRegardlessBuyer Or MyCommon.IsOfferCreatedWithUserAssociatedBuyer(AdminUserID, OfferID))
            If (Logix.UserRoles.EditOffer And m_EditOfferRegardlessOfBuyer And Not (FromTemplate And Disallow_Edit) And Not IsOfferWaitingForApproval(OfferID)) Then
                Send_Save()
            End If
        Else
            If (Logix.UserRoles.EditTemplates And m_EditOfferRegardlessOfBuyer) Then
                Send_Save()
            End If
        End If
