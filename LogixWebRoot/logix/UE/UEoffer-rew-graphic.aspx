...
<%
    ' *****************************************************************************
    ' * FILENAME: UEoffer-rew-graphic.aspx 
    ' *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    Response.Expires = 0
    MyCommon.AppName = "UEoffer-rew-graphic.aspx"
    ...
    If (bPreviewOnly) Then
        ...
        PreviewGraphicPath = "/logix/graphic-display-img.aspx?path="
    ...
    If (Request.QueryString("save") <> "" AndAlso Request.QueryString("additem") <> "") Then
        ...
        If Not (CloseAfterSave) Then
            ...
            Response.AddHeader("Location", "UEoffer-rew-graphic.aspx" & QryStr)
        End If
...
<script type="text/javascript" language="javascript">
  ...
  function showFullSize(path) {
      ...
      if (elem != null) {
          ...
          if (elemImg != null) {
              elemImg.src = "/logix/graphic-display-img.aspx?path=" + escape(path);
          }
...
<%
  ...
  If (Phase = 3) Then
        If (EngineID = 6) Then
            Send("  if (opener != null) {")
            Send("    var newlocation = 'CAM/CAM-offer-rew.aspx?OfferID=" & OfferID & "'; ")
  ...
  ElseIf (Phase = 1) Then
        If (EngineID = 3) Then
            ...
            Send("  if (opener.location.href.indexOf(newlocation) >-1) {")
            Send("  window.parent.opener.location = '/logix/web-offer-not.aspx?OfferID=" & OfferID & "'; ")
...
<form action="#" id="mainform" name="mainform">
  <div id="intro">
    ...
    %>
    <div id="controls">
      <%If (Not bPreviewOnly And Not IsOfferWaitingForApproval(OfferID)) Then
        ...
        <%
          ...
          Else
            ...
            MyCommon.QueryStr = "select ot.TerminalTypeID, tt.AnyTerminal from offerterminals ot with (NoLock) " & _
                                ...
                                "where offerid=" & OfferID & " and tt.deleted=0 and tt.EngineID=9 and ot.excluded=0;"
            rst = MyCommon.LRT_Select()
            ...
            <%
              ...
              If (rst.Rows.Count > 0) Then
                For Each row In rst.Rows
                  ...
                  Send("<td><a href=""javascript:showFullSize('" & jsPath & "');""><img id=""imgGraphic" & MyCommon.NZ(row.Item("PKID"), "0") & """ src=""/logix/graphic-display-img.aspx?path=" & GraphicPath & "&lang=" & LanguageID & """ alt=""" & Copient.PhraseLib.Lookup("reward.graphic-clicktoview", LanguageID) & """ title=""" & Copient.PhraseLib.Lookup("reward.graphic-clicktoview", LanguageID) & """ /></a></td>")
    ...
    Try
      ...
      If (dst.Rows.Count > 0) Then
        ...
        If (GraphicPath.Trim().Length = 0) Then
          GraphicPath = MyCommon.Get_Install_Path()
        End If
