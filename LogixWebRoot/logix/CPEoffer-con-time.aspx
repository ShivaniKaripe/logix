...
<%
  ' *****************************************************************************
  ' * FILENAME: CPEoffer-con-time.aspx 
  ' *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  Response.Expires = 0
  MyCommon.AppName = "CPEoffer-con-time.aspx"
  ...
  If (Request.QueryString("save") <> "" OrElse Request.QueryString("saveTimeSlot") = "1") Then
    ...
    If (Request.QueryString("startHour") <> "" OrElse Request.QueryString("startMinute") <> "" OrElse Request.QueryString("endHour") <> "" OrElse Request.QueryString("endMinute") <> "") Then
      ...
      If Not Integer.TryParse(Request.QueryString("startHour"), StartHour) OrElse StartHour < 0 OrElse StartHour > 23 Then
      ...
      ElseIf Not Integer.TryParse(Request.QueryString("endHour"), EndHour) OrElse EndHour < 0 OrElse EndHour > 23 Then
      ...
      <div class="box" id="time" style="min-height: 300px; height: auto !important; height: 300px;">
        ...
        <%
          ...
          If (rst.Rows.Count > 0) Then
            ...
            Send("<tr>")
            Send("  <th class=""th-del"">" & Copient.PhraseLib.Lookup("term.delete", LanguageID) & "</th>")
            Send("  <th class=""th-date"">" & Copient.PhraseLib.Lookup("term.StartTime", LanguageID) & "</th>")
            Send("  <th>" & Copient.PhraseLib.Lookup("term.EndTime", LanguageID) & "</th>")
            Send("</tr>")
