...
<%
  ' *****************************************************************************
  ' * FILENAME: CPEoffer-con-pref.aspx 
  ' *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
<script runat="server">
  ...
  Sub Send_Page()
    ...
    Common.AppName = "CPEoffer-con-pref.aspx"
  ...
  Sub Send_Head()
    ...
    Send("  opener.location = 'CPEoffer-con.aspx?OfferID=" & PrefCon.Offer.ID & "'; ")
    Send("} ")
    Send("</" & "script>")
    Send_Selector_JS()
    Send_Value_Load_JS()
  ...
  Sub Send_Preference_Box()
    ...
    Send("  </h2>")
    Send("  <br class=""half"" />")
    Send("  <input type=""radio"" id=""functionradio1"" name=""functionradio"" checked=""checked""" & DisabledAttribute & " /><label for=""functionradio1"">" & Copient.PhraseLib.Lookup("term.startingwith", LanguageID) & "</label>")
    Send("  <input type=""radio"" id=""functionradio2"" name=""functionradio""" & DisabledAttribute & " /><label for=""functionradio2"">" & Copient.PhraseLib.Lookup("term.containing", LanguageID) & "</label><br />")
