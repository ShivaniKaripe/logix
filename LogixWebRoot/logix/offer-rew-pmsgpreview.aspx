...
<%
  ...
  {"|EOM_DATE_MMDD|","|RewExpAmt|", "|POSNUM|", "|CUSTOMERID|", "|FIRSTNAME|", "|LASTNAME|", "|TSD|", "|LYTS|", "|HHSTD|", "|CURRDATE|", "|OFFERSTART|", "|OFFEREND|", "|TOTALPOINTS|", "|PTSASPEN|", "|ACCUMAMT|", "|REMAINAMT|", "|FTS|", "|FTSPG|", "|BACKSLASH|", "\n", "\2n", "\p", "\l", "\t", "\f", "\3j", "\0j", "\i", "\h", "\w", "\q", "\s", "\m", "\BX", "\BX.", "\1BX.", "\0BX."}, _
  {"xx/xx/xxxx","####", "####", "###################", "John", "Smith", "000.00", "000.00", "000.00", "xx/xx/xxxx", "xx/xx/xxxx", "xx/xx/xxxx", "xx", "xx", "000.00", "000.00", "###.##", "###.##", "\", "<br />", "", "|NORMAL|", "********************************************", "\0t", "\0f", "|CENTER|", "|LEFT|", "|THIN|", "|HIGH|", "|WIDE|", "|QUAD|", "|SMALL|", "|MEDIUM|", "\1BX{,,}", "\1BX{,,}", "\1BX{,,}", "\0BX"}}
  
  Dim SubExpTags(,) As String = { _
  {"\|SVEXP_EOM\[[0-9]+\]\|","\|SVVALEARNED\[[0-9]+\]\|","\|SVVALREDEEMED\[[0-9]+\]\|","\|NET\#[[0-9]+]\|", "\|EARNED\#[[0-9]+]\|", "\|INITIAL#\[[0-9]+]\|", "\|REDEEMED#\[[0-9]+]\|", "\|NET\$\[[0-9]+]\|", "\|INITIAL\$\[[0-9]+]\|", "\|EARNED\$\[[0-9]+]\|", "\|REDEEMED\$\[[0-9]+]\|", "\|SVBAL\[[0-9]+\]\|", "\|SVVAL\[[0-9]+\]\|", "\|UPCA\[[0-9]+\]\|", "\|UPCB\[[0-9]+\]\|", "\|SVRATIO\[[0-9]+\,[0-9]+\,[0-9,.]+\]\|", "\|LIFETIME\#[[0-9]+]\|", "\|EAN13\[[0-9]+\]\|"}, _
  {"###.##","###.##","###.##","###", "###", "###", "###", "###.##", "###.##", "###.##", "###.##", "###", "###.##", "<img src='../images/upca.png' \/>", "<img src='../images/upcb.png' \/>", "###.##", "###", "<img src='../images/ean13.png' \/>"}}
  ...
  'Fix IE8 compatability issue
  If InStr(MESSAGE, vbCrLf) Then
  ...
  For Each row In rst.Rows
    ...
    DScorecardText = FormatScorecardLine("ueoffer-rew-pmsgpreview.DiscountA", "0.50", PageWidth) & ControlChars.CrLf & FormatScorecardLine("ueoffer-rew-pmsgpreview.DiscountB", "0.50", PageWidth)
    DScorecardTextBottom = DScorecardText & ControlChars.CrLf & Space(38) & "<span style=""font-weight:bold;"">" & FormatScorecardLine("term.total", "$  1.00", PageWidth) & "</span>"
    DScorecardTextTop = "<span style=""font-weight:bold;"">" & FormatScorecardLine("term.ScorecardTitle", "$  1.00", PageWidth) & "</span>" & ControlChars.CrLf & Space(38) & ControlChars.CrLf & FormatScorecardLine("ueoffer-rew-pmsgpreview.DiscountA", "0.50", PageWidth) & ControlChars.CrLf & FormatScorecardLine("ueoffer-rew-pmsgpreview.DiscountB", "0.50", PageWidth)
    LScorecardText = "Offer A                              2<br />Offer B                              4"
    ...
    ElseIf (MyCommon.NZ(row.Item("ScorecardTypeID"), 0) = 3) Then
      ...
      Else
        ...
        End If
      End If
    ElseIf (MyCommon.NZ(row.Item("ScorecardTypeID"), 0) = 4) Then
      ' Limits scorecard
      MESSAGE = Regex.Replace(MESSAGE, "\|LSCORECARD\[" & row.Item("ScorecardID") & "\]\|", IIf(MyCommon.NZ(row.Item("Bold"), 0) = 0, LScorecardText, "<b>" & LScorecardText & "</b>"))
    End If
  Next
...
<div id="main">
  ...
  <div id="column2x">
    <div id="pmsgpreview">
      <div id="pmsgpreviewbody"><pre><% Sendb(MESSAGE)%></pre></div>
    </div>
  </div>
...
<style type="text/css">
    ...
    #pmsgpreviewbody > pre > span:nth-of-type(even) > span > span:first-child
    {
        letter-spacing: 7px !important;
    }
    
    #pmsgpreviewbody > pre > span:nth-of-type(even) > span > span > span :first-child
    {
        letter-spacing: 7px !important;
    }
</style>
