...
<%
  ...
  LogFile = "UE-InstantWinLog-" & Format(LocalServerID, "00000") & "." & Common.Leading_Zero_Fill(Year(Today), 4) & Common.Leading_Zero_Fill(Month(Today), 2) & Common.Leading_Zero_Fill(Microsoft.VisualBasic.DateAndTime.Day(Today), 2) & ".txt"
  ...
  Common.Open_LRTsp()
  Common.LRTsp.Parameters.Add("@LocationID", SqlDbType.BigInt).Value = TempLocationID
  ...
  Else
    ...
    ElseIf Not (Connector.IsValidLocationForConnectorEngine(Common, LocationID, 9)) Then
      'the location calling InstantWin is not associated with the UE promoengine
