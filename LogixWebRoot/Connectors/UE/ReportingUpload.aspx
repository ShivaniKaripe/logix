...
<script runat="server">
  ...
  Sub Handle_Post(ByVal LocalServerID As Long, ByVal LocationID As Long, ByVal Mode As String)
    ...
    If Not (MD5 = "") Then
      'if we got an MD5 checksum, make sure it matches the decompressed data we received
...
<%
  ...
  If ProcessOK Then
    ...
    ElseIf Not (Request.QueryString("force") = "1") AndAlso Not (Connector.IsValidLocationForConnectorEngine(Common, LocationID, 9)) Then
      'the location calling ReportingUpload is not associated with the UE promoengine
