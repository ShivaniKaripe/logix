...
<script runat="server">
  ...
  Sub SD(ByVal OutStr As String, Optional ByVal isEncrypted As Boolean = False)
        'PrintLine(FileNum, OutStr)
        'If (isEncrypted) Then
        '    Dim UserData() As String = OutStr.Split(Chr(30))
        '    If (UserData.Length > 11 AndAlso Not String.IsNullOrWhiteSpace(UserData(11)) AndAlso Not UserData(11) = "0") Then
        '        Dim EncryptedExternalID As String = UserData(11)
        '        Dim DecryptedExternalID As String = MyCryptLib.SQL_StringDecrypt(EncryptedExternalID)
        '        OutStr = OutStr.Replace(EncryptedExternalID, DecryptedExternalID)
        '    End If
        'End If
        Dim Bytes As Byte()
