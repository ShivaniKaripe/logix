...
<script runat="server">
  ...
  Public CPEEnterprise As Boolean
...
<%
  ...
  LastHeard = "1/1/1980"
  CPEEnterprise = False
  If Request.QueryString("cpeenterprise") = "1" Then
    CPEEnterprise = True
  End If
  ...
  ElseIf Not (Connector.IsValidLocationForConnectorEngine(Common, LocationID, 2)) Then
    'the location calling IPL-UR is not associated with the CPE promoengine
