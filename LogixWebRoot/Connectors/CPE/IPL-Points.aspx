...
<script runat="server">
  ...
  Function Construct_Table(ByVal TableName As String, ByVal Operation As Integer, ByVal DelimChar As Integer, ByVal LocalServerID As String, ByVal LocationID As String, ByVal DBName As String) As String
    ...
    If reader.HasRows Then
      If UCase(TableName) = "POINTS" Then
        FieldList = "ProgramID" & Chr(DelimChar) & "UserID" & Chr(DelimChar) & "PointsAmt"
      End If
      ...
      If UCase(TableName) = "POINTS" And (Operation = 5) Then
        While reader.Read
  ...
  Sub Construct_Output(ByVal LocalServerID As Long, ByVal LocationID As Long)
    ...
    'Points
    Common.QueryStr = "EXEC [dbo].[pa_CPE_IPL_Points] " & LocationID
    OutStr = OutStr & Construct_Table("Points", 5, DelimChar, LocalServerID, LocationID, "LXS")
...
<%
  ...
  ElseIf Not (Connector.IsValidLocationForConnectorEngine(Common, LocationID, 2)) Then
    'the location calling IPL-Points is not associated with the CPE promoengine
