...
<%
  ...
  End If
  LocalServerID = Common.Extract_Val(Request.QueryString("serial"))
  LogFile = "CPE-OfferValidationLog-" & Format(LocalServerID, "00000") & "." & Common.Leading_Zero_Fill(Year(Today), 4) & Common.Leading_Zero_Fill(Month(Today), 2) & Common.Leading_Zero_Fill(Microsoft.VisualBasic.DateAndTime.Day(Today), 2) & ".txt"
  LocalServerIP = Request.QueryString("IP").Trim
  If LocalServerIP = "" Or LocalServerIP = "0" Then
