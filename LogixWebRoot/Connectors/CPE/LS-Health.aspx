...
<%
  ...
  Response.Expires = 0
    ...
    LocalServerID = Common.Extract_Val(Request.QueryString("serial"))
    LogFile = "CPE-LS-HealthLog." & Common.Leading_Zero_Fill(Year(Today), 4) & Common.Leading_Zero_Fill(Month(Today), 2) & Common.Leading_Zero_Fill(Microsoft.VisualBasic.DateAndTime.Day(Today), 2) & ".txt"
    LocalServerIP = Trim(Request.QueryString("IP"))
    MacAddress = Trim(Request.QueryString("mac"))
    If MacAddress = "" Or MacAddress = "0" Then
        MacAddress = "0"
