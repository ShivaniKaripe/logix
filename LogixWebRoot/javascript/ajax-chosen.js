...
(function ($) {
  ...
  defaultOptions = {
    ...
    afterTypeDelay: 500,
    jsonTermKey: "term",
    keepTypingMsg: GlobalObject.KeepTyping,//"Keep typing...",
    lookingForMsg: GlobalObject.LookingFor//"Looking for"
  };
  return ajaxChosen = (function () {
    ...
    ajaxChosen.prototype.register_observers = function () {
      ...
      this.search_field.blur(function (evt) {
          this.search_field.val(GlobalObject.SelectAValue);
          _this.update_list(evt);
      });
...
//      });
    ...
    ajaxChosen.prototype.update_list = function (evt) {
      ...
      val = EncodeSpecialCharacters(val);
      if (this.options.additionalparams != null && this.options.additionalparams != "undefined") {
        this.options.data = '{"' + this.options.jsonTermKey + '": "' + val + '", ' + this.options.additionalparams + ' }';
      }
      else {
        this.options.data = '{"' + this.options.jsonTermKey + '": "' + val + '" }';
      }
    ...
    ajaxChosen.prototype.show_results = function (data) {
      ...
      nbItems = 0;
      _this = this;
      if (items.d !=null && items.d != undefined) {
          $.each(items.d, function (i, element) {
...
function EncodeSpecialCharacters(obj) {
